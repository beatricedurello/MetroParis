...
class Model:
    ...
    def getBFSTree(self, source):
        ...
        #ritorna un grafo/albero orientato costruito con il metodo breadth first a partire da source
        archi = tree.edges()
    ...
    def getDFSNodesFromTree(self, source):
        ...
        # ritorna un grafo/albero orientato costruito con il metodo depth first a partire da source
        nodi = list(tree.nodes())
        return nodi[1:]
    ...
    def addEdgesVel(self):
        """Aggiungo archi con peso uguale al tempo di percorrenza dell'arco"""
        self._grafo.clear_edges()
    ...
    def addEdges2(self):
        """Ciclo solo una volta e faccio una query
        per trovare tutti i vicini"""
        for u in self._fermate:
    ...
    def addEdges3(self):
        """Faccio una query unica che prende tutti
        gli archi, poi ciclo qui"""
        allEdges = DAO.getAllEdges()
        for edge in allEdges:
            u = self._idMapFermate[edge.id_stazP]
            v = self._idMapFermate[edge.id_stazA]
